        ...
        availablePackages: [
          {
            ...
            packageType: 'WEEKLY',
            product: {
              identifier: 'premium_weekly_access:weekly-base',
          ...
          },
          {
            ...
            packageType: 'MONTHLY',
            product: {
              identifier: 'premium_monthly_access:monthly-base',
          ...
          {
            identifier: '$rc_quarterly',
            packageType: 'CUSTOM',
            product: {
              identifier: 'premium_quarterly_access:quarterly-access',
